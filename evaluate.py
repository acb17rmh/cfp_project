...
def evaluate(results_df):
    ...
    results_df['correct_end_date'] = results_df['end_date'] == results_df['detected_end_date']
    ...
    print("END DATE PERFORMANCE: \n CORRECT RECORDS {} \n ACCURACY {:.2%}"
          .format(results_df.correct_end_date.sum(), results_df.correct_end_date.sum() / number_of_records))
